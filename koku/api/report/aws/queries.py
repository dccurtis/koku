...
from api.report.base_query_handler import ReportQueryHandlerBase
...
class AWSReportQueryHandler(ReportQueryHandlerBase):
    ...
    def __init__(self, query_parameters, url_data,
        ...
        self.provider_name = query_parameters.get('provider', 'AWS')
        ...
        super().__init__(query_parameters, url_data,
                 tenant, self.default_ordering, self._mapper, **kwargs)
    ...
    def _get_group_by(self):
        ...
        group_by = []
        group_by_options = self._group_by_options
